...
const ChatBotWidget = ({ callApi, chatbotName = "Chatbot", isTypingMessage = "Typing...", IncommingErrMsg = "Oops! Something went wrong. Please try again.", primaryColor = "#eb4034", inputMsgPlaceholder = "Send a Message", chatIcon = React.createElement(ChatIcon, null), botIcon = React.createElement(BotIcon, null), botFontStyle = {}, typingFontStyle = {}, handleNewMessage, onBotResponse, messages = [], }) => {
        ...
        React.createElement("div", { className: "chatbot" },
            ...
            React.createElement("ul", { className: "chatbox", ref: chatboxRef },
                messages.map((msg, index) => (React.createElement("li", { key: index, className: `chat ${msg.role === "user" ? "outgoing" : "incoming"}` },
                    ...
                    React.createElement("p", { style: msg.role === "assistant"
                            ? botFontStyle
                            : msg.role === "error"
                                ? botFontStyle
                                : { background: primaryColor } }, msg.content)))),
